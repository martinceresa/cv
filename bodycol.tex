...
\cvsection{Experience}
    \cvevent{Formal Methods Engineer}{IO-G -- ARC}{05 2025 -- Ongoing}{Madrid, Spain}
    \begin{itemize}
      \item Mechanization of Midgard (L2 Optimistic Rollups) protocol in \emph{Lean4}.
      \item L2 Tokenomics design.
      \item Data Availability Layer for L2 rollups design.
      \item Safety Analysis and Verification of Cardano smart-contracts.
    \end{itemize}
    \divider
    %%%%%%%%%%%%%%%%%%%%
    \cvevent{Postdoc Researcher}{IMDEA Software Institute}{03 2023 -- 04 2025}{Madrid, Spain}
    \begin{itemize}
        \item Formalized Fraud Proof games in \emph{Lean}.
        \item Designed offline monitoring properties for smart-contracts.
        \item Designed and implemented (in Haskell) Termina, a
            \textbf{non}-turing complete language for real-time critical embedded software.
        ...
        \item Guided PhD students and interns.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Collaborated on the development of online monitors to blockchains.
            % a theory to introduce
            % online transaction monitors to blockchain
            % technologies.
      \item Collaborated in the implementation of Setchain (Byzantine tolerant grow-only sets).
            % Participated in the implementation and development of
...
\cvsection{COURSES}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \cvevent{DeepSpec Summer School\cvreference{\faGlobe}{https://deepspec.org/event/dsss18/}}{Princeton University}{2018}{New Jersey, USA}
