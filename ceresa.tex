...
\begin{document}
    ...
    \tagline{Formal Methods Engineer}
    %% You can add multiple photos on the left or right
    \photoL{4cm}{martin}

    \personalinfo{
        \begin{tabular}{c c c}
        \email{martin@ceresa.ar} & \phone{+34-684319338} & \location{Madrid, Spain}\\
        \linkedin{martinceresa} & \github{martinceresa} & \homepage{martinceresa.github.io}
        \end{tabular}
        % \npm{npmUser}
        % \dev{devtoUser}
        %\medium{nicolasomar}
