...
\cvsection{Tech Languages}
    ...
    \begin{sloppypar*}
      \cvtags{Haskell, Lean4, Coq, Agda}

      \divider

      \cvtags{Go, C, Python, Rust, SML, Erlang}
...
\cvsection{TECH Stack}
    \begin{sloppypar*}
        ...
        \cvtags{ViM + Emacs, XMonad, Hakyll, Git, \LaTeX, Markdown + Org, GNU/Linux}
    \end{sloppypar*}
% ----- TECH STACK -----
...
\cvsection{LANGUAGES}
    ...
    \divider
    \cvlang{Portuguese}{Intermediate}
...
% ----- PROJECTS -----
\cvsection{Projects}
    \cveventpp{Termina}{}{2023 -- Ongoing}{\cvreference{\faGithub}{https://github.com/termina-lang/termina}}
    ...
    \cveventpp{FraudProofs}{}{2024 -- Ongoing}{\cvreference{\faGitlab}{https://gitlab.software.imdea.org/martin.ceresa/leanfpgames}}
    Mechanization of Fraud-Proof arbitration games in L2 Optimistic Rollups.
    Implemented in Lean4, focused on proving honest players always win.

    \divider

    \cveventp{Smart Multi Contract Interaction}{}{2021 -- 2022}{\cvreference{\faGitlab}{https://gitlab.software.imdea.org/martin.ceresa/multi}}
